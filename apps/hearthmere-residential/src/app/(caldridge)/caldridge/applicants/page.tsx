...
import { CheckIcon } from '@caldridge/components/icons';
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/caldridge/applicants' },
};
...
const screeningDisclaimer = `This fictional showcase performs no applicant screening or decision-making.
Do not enter real personal, financial, identity, or housing-history information.`;
      ...
      <Container>
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="mt-8 p-8">
            ...
            <p className="mt-6 text-sm text-gray-500 whitespace-pre-line">
              {screeningDisclaimer}
            </p>
          </Card>
