...
import { ScoreCircle } from '@alderwyck/components/ui/ScoreCircle';
import { CTABanner } from '@alderwyck/components/sections/CTABanner';
import { propertyConfig } from '@alderwyck/config/property';
import { neighborhoodSections, walkScore } from '@alderwyck/config/neighborhood';
import { getAmenityIcon } from '@alderwyck/components/icons';

export const metadata: Metadata = {
  title: 'Neighborhood',
  description: `Preview fictional destinations and illustrative mobility details near ${propertyConfig.name} in ${propertyConfig.address.city}.`,
  alternates: { canonical: '/alderwyck/neighborhood' },
};
