...
import { ScoreCircle } from '@larkmere/components/ui/ScoreCircle';
import { CTABanner } from '@larkmere/components/sections/CTABanner';
import { propertyConfig } from '@larkmere/config/property';
import { neighborhoodSections, walkScore } from '@larkmere/config/neighborhood';
import { getAmenityIcon } from '@larkmere/components/icons';

export const metadata: Metadata = {
  title: 'Neighborhood Data Demo',
  description: `Browse invented destination cards, distances, and mobility scores created for the ${propertyConfig.name} portfolio interface.`,
  alternates: { canonical: '/larkmere/neighborhood' },
};
