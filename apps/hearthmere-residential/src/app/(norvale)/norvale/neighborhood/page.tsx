...
import { ScoreCircle } from '@norvale/components/ui/ScoreCircle';
import { CTABanner } from '@norvale/components/sections/CTABanner';
import { propertyConfig } from '@norvale/config/property';
import { neighborhoodSections, walkScore } from '@norvale/config/neighborhood';
import { getAmenityIcon } from '@norvale/components/icons';

export const metadata: Metadata = {
  title: 'Neighborhood',
  description: `Browse fictional destinations, travel distances, and mobility examples around the Juniper Loop portfolio setting.`,
  alternates: { canonical: '/norvale/neighborhood' },
};
