...
export const seoConfig = {
  ...
  defaultDescription: `Explore the fictional ${propertyConfig.name} portfolio showcase. Preview 1, 2, and 3 bedroom layouts, community features, and illustrative neighborhood details in ${propertyConfig.address.city}.`,
  keywords: [
    ...
    'illustrative pet-friendly concept',
...
export const pageSeoConfig = {
  ...
  floorPlans: {
    ...
    description: `Explore fictional one-, two-, and three-bedroom floor plans at ${propertyConfig.name}. Synthetic monthly values begin at $${getPriceRange().min}.`,
  ...
  amenities: {
    ...
    description: `Preview fictional amenities at ${propertyConfig.name}, including shared recreation, a work lounge, laundry, and resident parking.`,
