...
import { featuredAmenities } from '@larkmere/config/amenities';
import { getAmenityIcon, ArrowRightIcon } from '@larkmere/components/icons';
      ...
      <Container>
        <div className={`text-center max-w-2xl mx-auto animate-on-scroll ${isVisible ? 'is-visible' : ''}`}>
          ...
          <p className="mt-4 text-lg">
            <span className="font-semibold text-gray-900">Inspect the content pattern</span>{' '}
            <span className="text-gray-500">through fictional shared-space and interior-feature examples.</span>
          </p>
        </div>
