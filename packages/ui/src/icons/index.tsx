...
export function MenuIcon({ className, ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={cn('h-6 w-6', className)} {...props}>
...
export function PhoneIcon({ className, ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={cn('h-5 w-5', className)} {...props}>
...
export function ArrowRightIcon({ className, ...props }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={cn('h-5 w-5', className)} {...props}>
...
export function EqualHousingIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={cn('h-8 w-8', className)} aria-label="Illustrative equal housing symbol" role="img" {...props}>
...
export function CookieIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className={cn('h-6 w-6', className)} {...props}>
...
export function BrandMarkIcon({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 48 32"
      role="img"
      aria-label="Hearthmere logo mark"
      className={cn('h-8 w-8', className)}
      {...props}
    >
      <polygon points="2,30 18,2 28,12 12,30" fill="var(--color-secondary-400)" />
      <polygon points="18,30 32,8 42,18 28,30" fill="var(--color-secondary-600)" />
      <polygon points="30,30 38,22 46,30" fill="#ffffff" />
    </svg>
  );
}
